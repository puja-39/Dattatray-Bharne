...
<div class="modal d-block pos-static">
    ...
    <div class="col-md-4 mb-3">
      <div class="form-group">
            ...
            {!! rohan_file_manager_input('image', 'image', 'image', isset($gallery['image']) ? $gallery['image'] : '', false, '250px', '250px') !!}
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-8 mb-3">
                <div class="form-group">
                    ...
                    <input  type="text" class="form-control" name="name" placeholder="{{ translate('Enter Name') }}" value="{{ isset($gallery['name']) ? $gallery['name'] : '' }}" required>
                </div>
            </div>
            <div class="col-md-4 mb-3">
                <div class="form-group">
                    ...
                    <select name="is_active" class="form-control select2-modal" data-parsley-errors-container="#error_status" required>
                        ...
                        <option value="1" {{ isset($gallery['is_active']) && $gallery['is_active'] == '1' ? 'selected' : '' }}>{{ translate('Active') }}</option>
                        <option value="0" {{ isset($gallery['is_active']) && $gallery['is_active'] == '0' ? 'selected' : '' }}>{{ translate('Inactive') }}</option>
                    </select>
        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="short_description"  placeholder="{{ translate('short description') }}" value="{{ isset($gallery['short_description']) ? $gallery['short_description'] : '' }}" required>
                </div>
            </div>
        </div>
        </div>
        </div> 
        {!! rohan_file_manager_input('images', 'images', 'images', 
         isset($gallery['images']) ? $gallery['images'] : '', false, '250px', '250px', 'multiple') !!}                    
