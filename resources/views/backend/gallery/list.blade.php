@extends('backend.app')
@section('page_title')Gallery @endsection
@section('style_files')
...
@section('content')
	<div class="page-header">
		...
		<div class="btn btn-list">
				<a class="btn ripple popup-page btn-primary" href="{{ route('admin.gallery.new') }}"><i class="fe fe-plus-circle ml-2"></i> {{ translate('Add New') }}</a>
		</div>
    </div>
