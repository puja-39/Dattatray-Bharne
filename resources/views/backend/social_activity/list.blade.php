...
@section('content')
	<div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">{{ translate('Blog') }}</h2>
            <ol class="breadcrumb">
		...
		<div class="btn btn-list">
				<a class="btn ripple btn-primary" href="{{ route('admin.blog.new') }}"><i class="fe fe-plus-circle ml-2"></i> {{ translate('Add New') }}</a>
		</div>
    </div>
