@extends('backend.app')
@section('page_title'){{ translate('Contact Enquiry') }} @endsection
...
@section('content')
	<div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">{{ translate('Enquiry') }}</h2>
            <ol class="breadcrumb">
	...
	<script>
		$(document).ready(function () {
			$('.data-list-table').DataTable({
				...
				"serverSide": true,
				"ajax": {
					"url": "{{ route('admin.enquiry.contact_list') }}",
					"dataType": "json",
					"type": "POST",
