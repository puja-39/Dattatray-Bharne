@extends('backend.app')
@section('page_title'){{ translate('Subscribe Enquiry') }} @endsection
...
@section('content')
	<div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">{{ translate('Subscribe') }}</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ translate('Dashboard') }}</a></li>
                <li class="breadcrumb-item"><a href="javascript:void(0);">{{ translate('Enquiry') }}</a></li>
                <li class="breadcrumb-item"><a href="javascript:void(0);">{{ translate('Subscribe') }}</a></li>
            </ol>
        </div>
    </div>
