...
<div class="modal d-block pos-static">
    ...
    <div class="col-md-4 mb-3">
      <div class="form-group">
            ...
            {!! rohan_file_manager_input('image', 'image', 'image', isset($hospital_help['image']) ? $hospital_help['image'] : '', false, '250px', '250px') !!}
        </div>
    </div>
    <div class="col-md-8 mb-3">
        <div class="row">
            <div class="col-md-8 mb-3">
                <div class="form-group">
                    ...
                    <input  type="text" class="form-control" name="name" placeholder="{{ translate('Enter Name') }}" value="{{ isset($hospital_help['name']) ? $hospital_help['name'] : '' }}" required>
                </div>
            </div>
            <div class="col-md-4 mb-3">
                <div class="form-group">
                    ...
                    <select name="is_active" class="form-control select2-modal" data-parsley-errors-container="#error_status" required>
                        ...
                        <option value="1" {{ isset($hospital_help['is_active']) && $hospital_help['is_active'] == '1' ? 'selected' : '' }}>{{ translate('Active') }}</option>
                        <option value="0" {{ isset($hospital_help['is_active']) && $hospital_help['is_active'] == '0' ? 'selected' : '' }}>{{ translate('Inactive') }}</option>
                    </select>
     ...
     <div class="modal-footer">
         ...
         <button type="submit" class="btn ripple btn-submit btn-primary"data-loading-text="<span aria-hidden='true' class='spinner-border spinner-border-sm'></span>
             {{ translate('please_wait...') }}"tabindex="7">{{ translate('Submit') }}</button>
     </div>
        </div>
    </form>
