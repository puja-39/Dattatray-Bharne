@extends('backend.app')
@section('page_title'){{ translate('journey') }} @endsection
@section('style_files')
...
@section('content')
	<div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">{{ translate('journey') }}</h2>
            <ol class="breadcrumb">
		...
		$(document).ready(function () {
			$('.data-list-table').DataTable({
				...
				"columns": [
					...
					{"data": "year", orderable: false, className: 'text-center'},
					{"data": "month", orderable: false, className: 'text-center'},
